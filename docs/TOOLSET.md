...
| Extension Data    | [mcp_ado_extensiondata_get_document](#mcp_ado_extensiondata_get_document)                                 | Get a document from an extension's data collection        |
| Extension Data    | [mcp_ado_extensiondata_get_documents](#mcp_ado_extensiondata_get_documents)                               | Get all documents from an extension's data collection     |
| Extension Data    | [mcp_ado_extensiondata_create_document](#mcp_ado_extensiondata_create_document)                           | Create a new document in an extension's data collection   |
| Extension Data    | [mcp_ado_extensiondata_set_document](#mcp_ado_extensiondata_set_document)                                 | Set (upsert) a document in an extension's data collection |
| Extension Data    | [mcp_ado_extensiondata_update_document](#mcp_ado_extensiondata_update_document)                           | Update an existing document in a collection               |
| Extension Data    | [mcp_ado_extensiondata_delete_document](#mcp_ado_extensiondata_delete_document)                           | Delete a document from an extension's data collection     |
...
### mcp_ado_extensiondata_get_document

Get a document from an extension's data collection by ID. Documents are JSON objects with special 'id' and '\_\_etag' properties for versioning.

- **Required**: `publisherName`, `extensionName`, `collectionName`, `documentId`
- **Optional**: `scopeType`, `scopeValue`

### mcp_ado_extensiondata_get_documents

Get all documents from an extension's data collection. Returns up to 100,000 documents.

- **Required**: `publisherName`, `extensionName`, `collectionName`
- **Optional**: `scopeType`, `scopeValue`

### mcp_ado_extensiondata_create_document
...
- **Required**: `publisherName`, `extensionName`, `collectionName`, `document`
- **Optional**: `scopeType`, `scopeValue`

### mcp_ado_extensiondata_set_document
...
**Note**: The document must include an 'id' property.

### mcp_ado_extensiondata_update_document

Update an existing document in an extension's data collection. The document must already exist. Use '\_\_etag' property for concurrency control (set to -1 for last-write-wins).

- **Required**: `publisherName`, `extensionName`, `collectionName`, `document`
- **Optional**: `scopeType`, `scopeValue`

**Note**: The document must include 'id' and '\_\_etag' properties.

### mcp_ado_extensiondata_delete_document
